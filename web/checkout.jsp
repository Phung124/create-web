<%-- 
    Document   : checkout
    Created on : Nov 16, 2022, 10:19:05 PM
    Author     : phuc
--%>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                              ...
                              <c:set var="t" value="${t+1}"/>
                                <ul>
                                    <li>${i.product.name} <span> <fmt:formatNumber type="number" pattern="##.#" value="${i.price*i.quantity}"/></span></li>
                                    
                                </ul>
                              </c:forEach>
                                <c:set var="d" value="${sessionScope.d}" />
                                <div class="checkout__order__total">Total <span>${d}</span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
                                ...
                                <div class="checkout__input__checkbox">
                                   ...
                                   <a href="checkout" class="primary-btn">ORDERS</a>
                            </div>
                        </div>
                    </div>
                </form>
